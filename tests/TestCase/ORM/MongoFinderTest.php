...
namespace Mofing\Mongodb\Test\TestCase\ORM;
...
class MongoTestsTable extends Table
{
    ...
    {
        $this->setTable('tests');
        $this->setEntityClass('Mofing\Mongodb\Test\TestCase\ORM\MongoTest');
...
class MongoFinderTest extends TestCase
{
    ...
    public function setUp()
    {
        parent::setUp();
        Cache::disable();
        $this->table = TableRegistry::get('MongoTests', ['className' => 'Mofing\Mongodb\Test\TestCase\ORM\MongoTestsTable']);
    }
